...
def parse_args():
    ...
    config_file = r"../configs/aa_badmintonCD/ALL-swin-tiny-patch4-window7_upernet_1xb8-80k_IS-512x512_match_noCrop_lowp_2500train.py"
    work_dir = os.path.join("../experiment", os.path.basename(config_file)[:-2])
