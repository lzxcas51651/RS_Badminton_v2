...
model = dict(
    pretrained='E:\lizhengcan\ISPRS-CD\mmsegmentation-fix_cd_transform\experiment\ALL-swin-tiny-patch4-window7_upernet_1xb8-80k_IS-512x512-ALL\iter_80000.pth',
